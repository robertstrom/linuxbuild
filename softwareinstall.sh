...
xclip sipcalc breeze-icon-theme deja-dup smbclient cifs-utils xsltproc powershell
# archivemount safecopy dcfldd dc3dd gnome-tweaks gnome-shell-extensions \
